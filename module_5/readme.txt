...
###Pylint run
pylint .\src\data_processing\clean.py
pylint .\src\data_processing\load_data.py
pylint .\src\data_processing\query_data.py
pylint .\src\data_processing\scrape.py
pylint .\src\__init__.py
pylint .\src\setup.py 
pylint .\src\flask_app.py
